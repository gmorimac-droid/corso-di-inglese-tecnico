...
| Attribute | Value |
| --- | --- |
| Module focus | Engineering Vocabulary Foundations |
| Area | Core Technical English |
| Operational purpose | Engineering vocabulary becomes useful only when it is organised by function, hierarchy, and documentary use. |
| Primary documentary output | Controlled vocabulary sheets for repeated technical use |
| Priority companion resources | [General Engineering Glossary](../glossaries/general-engineering-glossary.md)<br>[Useful Technical Verbs](../glossaries/useful-technical-verbs.md)<br>[Vocabulary Exercises](../exercises/vocabulary-exercises.md) |
...
Engineering vocabulary becomes useful only when it is organised by function, hierarchy, and documentary use. This module develops an active lexical base that supports description, explanation, and reporting across different technical domains.

Many learners know isolated words but cannot use them productively. They may recognise *component* and *system* but fail to show the structural relationship between them. Professional writing requires not only vocabulary size, but lexical architecture.
...
- classifying items by function
- describing hierarchy from part to system
- using collocations instead of word-by-word translation
- building glossary entries with usage notes
...
> The system has many pieces and all the pieces are important for operation.

### Stronger version

> The system is divided into several subsystems, each of which contains components with distinct electrical, structural, or interface functions.
...
A learner is asked to write a glossary page but includes only bilingual word pairs. The entries do not distinguish hierarchy, document use, or collocation. Redesign the glossary so that it supports future writing tasks rather than passive memorisation only.
...
Prepare ten glossary entries from one engineering field. Each entry must contain a definition, one example sentence, one collocation, and one usage warning for Italian-speaking learners.
...
Present the difference between **component**, **assembly**, **subsystem**, and **system** using a real or hypothetical engineering object as illustration.
...
Create `engineering-vocabulary-map.md` with lexical groups organised by hierarchy, function, and typical documents.
...
- [Useful Technical Verbs](../glossaries/useful-technical-verbs.md)
- [False Friends In Technical English](../language-tools/false-friends-in-technical-english.md)
...
A mixed civil-defence engineering team needs a stable terminology list so that design, maintenance, and quality staff stop using different words for the same object.

### Documentary risk

Vocabulary learning becomes weak when learners memorise isolated translations instead of recording collocation, document type, and typical grammatical behaviour.
...
A premium-quality lexical answer groups terms by function, component class, process, and documentary usage. It also distinguishes core meaning from operational nuance, for example the difference between *issue*, *fault*, *failure*, and *anomaly*.
...
Ask students to justify word choice rather than merely translating. The strongest learners can explain why one term fits a report while another fits a meeting update or a maintenance record.
...
Add a repository page that classifies high-frequency engineering terms by subsystem, function, and document context, with one realistic sentence per term.
