...
| Attribute | Value |
| --- | --- |
| Module focus | Describing Components and Assemblies |
| Area | Engineering Communication |
| Operational purpose | Component description requires the writer to combine physical, functional, and relational information. |
| Primary documentary output | Component description sheet |
| Priority companion resources | [Mechanical Terms](../glossaries/mechanical-terms.md)<br>[Phrasebank for Description](../language-tools/phrasebank-for-description.md)<br>[Technical Description Models](../model-answers/technical-description-models.md) |
...
Component description requires the writer to combine physical, functional, and relational information. A good technical description identifies what the item is, where it is located, how it is connected, what it is made of, and why it matters within the assembly.

Weak part descriptions often sound acceptable in conversation but fail in documentation because they omit location, interface, dimensions, material relevance, or functional role. This module develops concise but sufficiently explicit component-level writing.
...
Language work focuses on spatial phrasing, material statements, dimensional reference language, and function-led description. Useful frames include **is mounted on**, **is secured by**, **is positioned between**, **provides structural support for**, and **prevents relative movement between**.
...
- describing geometry and position
- explaining how parts are joined
- distinguishing visible description from functional significance
- moving from inventory-style lists to integrated prose
...
> The module is inside a box on the frame and it has screws and a connector.

### Stronger version

> The module is housed in a sealed aluminium enclosure mounted on the left-hand support frame. Four captive fasteners secure the enclosure, while a front-access connector provides controlled maintenance interface without full removal of the assembly.
...
Describe a component from a drawing or photograph, moving from identification to location, connection, function, and maintenance relevance.
...
Create `component-description-model.md` with labelled sections for identity, position, materials, interfaces, and function.
...
A supplier-facing description of a connector bracket must explain geometry, mounting, material, and function without becoming a full manufacturing specification.

### Documentary risk

Learners often list parts without describing relationship, orientation, or interface significance. The text remains descriptive but not engineering-useful.
...
A strong answer names the component, places it in the assembly, states what it supports or protects, and clarifies limitations such as access, tolerance, or load path relevance.
...
Encourage drawings or mental diagrams during correction. Many language errors originate from unclear spatial thinking rather than from vocabulary absence.
...
Create a component page with a definition table, location wording, material statement, and a short function paragraph.
