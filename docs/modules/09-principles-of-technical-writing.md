...
| Attribute | Value |
| --- | --- |
| Module focus | Principles of Technical Writing |
...
Technical writing seeks to maximise clarity, efficiency, and documentary value. This module establishes the style principles that govern strong engineering prose.

Learners often think that technical writing means using long sentences and specialised vocabulary. In reality, strong technical writing is usually more disciplined, more modular, and easier to review than weak writing.
...
The module highlights sentence control, paragraph architecture, and information sequencing. It also shows how punctuation, headings, lists, and labelled sections support readability in technical contexts.
...
- moving from speech-like writing to document-like writing
- deciding when lists are better than prose
- writing for skimming and later retrieval
- revising for traceability and reuse
...
> We checked the enclosure and connector and there was some contamination, so we cleaned it and then continued with the test.

### Stronger version

> Initial inspection identified local contamination around the lower connector interface. Although the condition did not prevent continuity checks, cleaning was performed before functional verification to preserve interface integrity and record a controlled maintenance action.
...
A paragraph contains all the necessary information but remains difficult to review because the logic is hidden inside long, speech-like sentences. Reorganise it so that the reader can identify observation, impact, and response immediately.
...
Rewrite a 200-word informal description into a documentation-quality paragraph set with headings and stronger information hierarchy.
...
Explain to a peer the difference between grammatically correct writing and professionally useful writing in an engineering context.
...
Create `technical-writing-style-guide.md` with rules, examples, and a revision checklist.
...
An internal review board rejects a draft because the content is technically correct but difficult to scan, inconsistent in terminology, and too conversational in tone.

### Documentary risk

Students may believe that correctness alone is enough. Premium technical writing requires retrievability, consistent document logic, and controlled sentence behaviour.
...
A strong answer demonstrates how to revise for clarity, consistency, sentence economy, and documentary purpose. The writer should be able to defend revision choices, not simply rewrite by instinct.
...
Use side-by-side comparison during feedback. The learner should see precisely how a weak sentence becomes a stronger documentary unit.
...
Create a style guide page with weak-vs-strong examples, revision checks, and model paragraph architecture.
