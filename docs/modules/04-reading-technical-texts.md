...
| Attribute | Value |
| --- | --- |
| Module focus | Reading Technical Texts |
| Area | Core Technical English |
| Operational purpose | Technical reading is selective, goal-oriented, and evidence-driven. |
| Primary documentary output | Annotated technical-reading record |
| Priority companion resources | [Reading Exercises](../exercises/reading-exercises.md)<br>[Phrasebank for Reporting](../language-tools/phrasebank-for-reporting.md)<br>[Report Models](../model-answers/report-models.md) |
...
Technical reading is selective, goal-oriented, and evidence-driven. The reader often searches for a parameter, a condition, a warning, a limitation, or a procedural dependency rather than reading linearly for general interest.

In engineering practice, reading efficiency affects safety, maintenance quality, and review speed. Readers must often navigate dense documents under time pressure. They therefore need strategies for extracting only what is operationally relevant without losing context.
...
The module emphasises scanning for data, recognising document signals, understanding cautionary language, and distinguishing requirement statements from explanatory notes. Learners also practise annotating texts for audience, action, and evidential status.
...
- locating critical data efficiently
- recognising section function in manuals and reports
- distinguishing description from instruction
- annotating texts for later reuse in documentation
...
> Read the text and try to understand the important information.

### Stronger version

> Before reading in detail, identify the operational range, the storage limitation, the protection requirement, and the condition that triggers additional verification.
...
A technician misreads an advisory note as a mandatory requirement, causing unnecessary delay. Review a short passage and mark which sentences are mandatory, advisory, descriptive, or conditional.
...
Prepare an annotated reading sheet for a one-page manual extract. Include purpose, audience, critical values, mandatory actions, and vocabulary notes.
...
Summarise a dense paragraph orally in under sixty seconds, preserving only the information that is operationally relevant to the user.
...
Create `reading-strategy-checklist.md` with a method for extracting limits, warnings, conditions, and references from technical documents.
...
- [Reading Exercises](../exercises/reading-exercises.md)
- [Functional Language](../language-tools/functional-language.md)
...
A learner must extract the relevant acceptance criteria from a dense technical page without copying unnecessary narrative detail.

### Documentary risk

Reading tasks often fail because learners either translate every line or skim without identifying purpose, scope, and evidence-bearing sections.
...
A strong answer identifies document purpose first, then extracts only the details that affect operation, compliance, configuration, risk, or decision-making.
...
Insist on information hierarchy. A good learner does not merely understand the page; they can explain which details matter and why.
...
Add an annotated-reading page showing how to scan headings, tables, cautions, and constraints before writing a summary.
...
This module should be studied together with [Reading Exercises](../exercises/reading-exercises.md) and the related template or exercise pages. Premium progression depends on repeated transfer, not on single-pass reading.
