...
| Attribute | Value |
| --- | --- |
| Module focus | Maintenance English |
...
Maintenance communication requires clear description of condition, activity, constraints, and release status. This module develops the core language of planned and corrective maintenance.

Maintenance texts are judged by practical usefulness. A reader needs to know what was checked, what was found, what was replaced, what remains open, and whether the item can return to service.
...
Useful patterns include **was inspected for**, **was replaced due to**, **remains serviceable**, **requires further monitoring**, and **was released to service following verification**. The module also reinforces time-sequence wording and condition reporting.
...
- describing maintenance without narrative clutter
- recording what was done and why
- separating observed condition from corrective action
- stating release status responsibly
...
> We checked the interface panel and cleaned it, and everything seemed okay afterwards.

### Stronger version

> The interface panel was inspected for mechanical damage, contamination, and connector wear. After approved cleaning and continuity verification, the unit remained in serviceable condition.
...
Prepare a corrective maintenance summary with condition, action, verification, and release status.
...
Describe a maintenance action to a supervisor, focusing on evidence and release criteria rather than on conversational detail.
...
Create `maintenance-record-model.md` linked to the maintenance log template and troubleshooting report template.
...
A maintenance technician must record inspection findings and replacement actions in a way that can be reused by engineering and quality teams.

### Documentary risk

Maintenance notes often omit context, serviceability judgement, or the reason why an intervention mattered.
...
A strong maintenance answer states item identity, condition found, action performed, post-action status, and any limitation still affecting service release.
...
Emphasise that maintenance writing is evidence writing. The note may later support trend analysis, warranty discussion, or audit review.
...
Add a maintenance page with log examples, serviceability phrases, and post-action release wording.
